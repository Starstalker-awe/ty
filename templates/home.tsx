...
export default function Home() {
	const age =
		new Date(new Date().getTime() - new Date(2006, 11, 27).getTime()).getFullYear() - 1970;
		...
		>
			<div class="flex md:flex-row flex-col items-start pb-16 bg-primaries-light md:*:w-1/2">
				<div class="py-8 md:p-8 p-4 my-auto">
					...
					<h3 class="md:text-left normal-case">
						Programmer, website builder & world traveler
					</h3>
				</div>
			...
			<div class="flex md:flex-row flex-col pb-16 bg-primaries-light md:*:w-1/2" id="about">
				...
				<div class="py-8 md:p-8 p-4 my-auto md:order-2 order-1">
					...
					<div class="md:px-16 px-8 child-p:pb-8">
						<p>
							<span class="font-semibold text-2xl">Hi there!</span> I'm Trevor—an{" "}
							{age}-year-old programmer, web developer, and world traveler with a
							passion for creating exceptional websites.
						</p>
						<p>
							Over the years, I've delved deep into cybersecurity, programming, web
							design, and the intricate systems that power our digital world. This
							journey has fueled my love for building fast, secure, and beautifully
							designed websites that stand the test of time.
						</p>
						<p>
							From crafting WordPress sites to coding fully custom projects (like this
							one), I've honed my skills with every project I take on, striving to
							deliver better results with each line of code.
						</p>
					</div>
				</div>
			</div>
			...
			<div
				class="bg-gradient-to-b from-primaries-light to-secondary/95 md:p-16 p-8"
				id="examples"
			>
			...
			<div class="md:p-16 py-8 px-2" id="contact">
				...
				<div class="flex md:flex-row flex-col justify-center md:items-start md:gap-12 gap-4 md:px-16 px-3">
					<div>
						<form class="grid grid-cols-2 gap-2 *:shadow-lg *:border-1 *:border-primaries-dark/25">
							...
							<textarea
								...
								required
							/>
							<button class="main-button col-span-2" type="submit">
								Send Me A Message
							</button>
						</form>
					...
					<div class="shadow-2xl p-8 rounded-lg overflow-hidden *:p-1 *:flex *:items-center">
						<a href="mailto:trevoryatesawesome@gmail.com">
							<Icon src={letter} width={30} />
							trevoryatesawesome@gmail.com
						</a>
						<a href="tel:+1-725-252-6491">
							<Icon src={phone} width={30} />
							(725) 252-6491
						</a>
						<a href="https://wa.me/50237983898" target="_blank">
							<Icon src={whatsapp} width={30} />
							Whatsapp
						</a>
					</div>
				</div>
